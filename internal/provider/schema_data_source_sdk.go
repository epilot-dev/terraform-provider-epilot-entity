...
func (r *SchemaDataSourceModel) RefreshFromGetResponse(resp *shared.EntitySchemaItem) {
	...
	for attributesCount, attributesItem := range resp.Attributes {
		...
		if attributesItem.SelectAttribute != nil {
			...
			for optionsCount, optionsItem := range attributesItem.SelectAttribute.Options {
				var options1 SelectAttributeOptions
				if optionsItem.Option != nil {
					options1.Option = &MultiSelectAttribute2{}
					if optionsItem.Option.Title != nil {
						options1.Option.Title = types.StringValue(*optionsItem.Option.Title)
					} else {
						options1.Option.Title = types.StringNull()
					}
					options1.Option.Value = types.StringValue(optionsItem.Option.Value)
				}
				...
				if optionsCount+1 > len(attributes1.SelectAttribute.Options) {
		...
		if attributesItem.MultiSelectAttribute != nil {
			...
			for optionsCount1, optionsItem1 := range attributesItem.MultiSelectAttribute.Options {
				...
				if optionsItem1.MultiSelectAttribute2 != nil {
					options3.Two = &MultiSelectAttribute2{}
					if optionsItem1.MultiSelectAttribute2.Title != nil {
						options3.Two.Title = types.StringValue(*optionsItem1.MultiSelectAttribute2.Title)
					} else {
						options3.Two.Title = types.StringNull()
					}
					options3.Two.Value = types.StringValue(optionsItem1.MultiSelectAttribute2.Value)
				}
				if optionsCount1+1 > len(attributes1.MultiSelectAttribute.Options) {
	...
	for capabilitiesCount, capabilitiesItem := range resp.Capabilities {
		...
		for attributesCount1, attributesItem1 := range capabilitiesItem.Attributes {
			...
			if attributesItem1.SelectAttribute != nil {
				...
				for optionsCount3, optionsItem3 := range attributesItem1.SelectAttribute.Options {
					var options8 SelectAttributeOptions
					if optionsItem3.Option != nil {
						options8.Option = &MultiSelectAttribute2{}
						if optionsItem3.Option.Title != nil {
							options8.Option.Title = types.StringValue(*optionsItem3.Option.Title)
						} else {
							options8.Option.Title = types.StringNull()
						}
						options8.Option.Value = types.StringValue(optionsItem3.Option.Value)
					}
					...
					if optionsCount3+1 > len(attributes3.SelectAttribute.Options) {
			...
			if attributesItem1.MultiSelectAttribute != nil {
				...
				for optionsCount4, optionsItem4 := range attributesItem1.MultiSelectAttribute.Options {
					...
					if optionsItem4.MultiSelectAttribute2 != nil {
						options10.Two = &MultiSelectAttribute2{}
						if optionsItem4.MultiSelectAttribute2.Title != nil {
							options10.Two.Title = types.StringValue(*optionsItem4.MultiSelectAttribute2.Title)
						} else {
							options10.Two.Title = types.StringNull()
						}
						options10.Two.Value = types.StringValue(optionsItem4.MultiSelectAttribute2.Value)
					}
					if optionsCount4+1 > len(attributes3.MultiSelectAttribute.Options) {
